...
internal class Task1
{
    ...
    public void DoTasks()
    {
       ...
       //zad 2.Znajd� osoby pe�noletnie.
        var q2 = people.Where(p => p.Age > 18);
        Print("Zadanie 2", q2);

        // Zadanie 3. Posortuj osoby po wieku rosnąco
        var q3 = people.OrderBy(p => p.Age);
        Print("Zadanie 3", q3);

        // zad  4.Posortuj osoby po nazwisku malej�co.
        var q4 = people.OrderByDescending(p => p.Age);
           Print("zad4" , q4);

        //zad 5.Wypisz tylko imi� i nazwisko ka�dej osoby.
        var q5 = people.Select((p =>  p.FirstName + p.LastName));
        Print("zad5", q5);

        //zad 6.Wypisz tylko miasta bez duplikat�w.
